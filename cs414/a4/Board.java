...
public class Board {
	...
	public Square initialize(){
		...
		Deed   kr = new Deed("BROWN","OLD KENT ROAD",60,50,50);
		Square cc = new Square("GRAY","COMMUNITY CHEST");
		Deed   wr = new Deed("BROWN","WHITECHAPEL ROAD",60,50,50);
		Square it = new Square("GRAY","INCOME TAX");
		RailRoad kc = new RailRoad("GRAY","KINGS CROSS STATION",200);
		Deed ai = new Deed("BLUE","THE ANGEL ISLINGTON",100,50,50);
		Square ch1 = new Square("GRAY","CHANCE");
		Deed er    = new Deed("BLUE","EUSTON ROAD",100,50,50);
